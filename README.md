...
**This project is a modified version of [Neo23x0/yarGen](https://github.com/Neo23x0/yarGen.git).**
**All original credits and license terms apply. See the LICENSE file for details.**

---

## Additional Features in This Modified Version

- **Interactive Custom YARA Rule Generator:**
  - Create YARA rules without malware samples, using your own threat intelligence (IOCs, strings, domains, IPs, URLs, etc.) or custom criteria.
  - Run:
    ```
    python yarGen.py --custom-rule
    ```
